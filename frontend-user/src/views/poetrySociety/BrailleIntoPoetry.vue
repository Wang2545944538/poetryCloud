<template>
  ...
  <el-container>
    ...
    <el-aside width="300px" class="full-height-aside">
      <img src="/user/images/img/poetryLeft.jpg" alt="Left Image Description" class="full-height-image">
    </el-aside>
    ...
    <!-- 右侧 Aside -->
    <el-aside width="300px" class="full-height-aside">
      <img src="/user/images/img/poetryRight.jpg" alt="Left Image Description" class="full-height-image">
    </el-aside>
  </el-container>
