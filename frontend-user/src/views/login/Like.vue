...
onMounted(() =>{
  const account = route.query.account === undefined ? sessionStorage.getItem('account') : route.query.account
  let infoUrl = 'http://localhost:20000/music/user/music_num?account=' + account
  let likeUrl = 'http://localhost:20000/music/user/music?account=' + account
...
<!--    <div>-->
      <div class="song-row grayBg">
        ...
        <span class="c2">作者</span>
        <span class="c3">名句</span>
