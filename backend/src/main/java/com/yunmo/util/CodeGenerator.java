...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/yunmo?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8&allowPublicKeyRetrieval=true");
...
//        strategy.setControllerMappingHyphenStyle(true);
        ...
        //指定某张表生成代码
        //strategy.setInclude("emp","dept","users","news", "newstype");
