    ...
    <el-table-column label="操作" width="150" align="center">
      <template #default="scope">
        <div style="display: flex; justify-content: space-around; align-items: center;">
          <el-button type="success" :icon="Check" circle @click="check(scope.row)" />
          <el-button type="danger" :icon="Close" circle @click="close(scope.row)" />
        </div>
      </template>
    </el-table-column>
  </el-table>
